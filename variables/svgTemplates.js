...
export const createStoryUpTextSvg = (fixedSize, firstText, secondText) => {
  ...
  <svg width="${fixedSize}" height="${fixedSize + 300}">
    ...
    <text x="50" y="${
        fixedSize - 990
    }" font-family: 'Century Gothic Paneuropean', sans-serif; font-size="70" fill="white" text-anchor="start">${firstText}</text>
    <text x="50" y="${
        fixedSize - 890
    }" font-family: 'Century Gothic Paneuropean', sans-serif; font-size="70" fill="white" text-anchor="start">${secondText}</text>
  </svg>
`;
};
...
export const createTextSvg = (fixedSize, firstText, secondText) => {
    ...
    <svg width="${fixedSize}" height="${fixedSize}">
      ...
      <text x="50%" y="${
          fixedSize - 150
      }" font-family: 'Century Gothic Paneuropean', sans-serif; font-size="75" fill="white" text-anchor="middle">${firstText}</text>
      <text x="50%" y="${
          fixedSize - 40
      }" font-family: 'Century Gothic Paneuropean', sans-serif; font-size="75" fill="white" text-anchor="middle">${secondText}</text>
    </svg>
  `;
};
